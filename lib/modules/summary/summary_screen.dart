...
class _SummaryScreenState extends State<SummaryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final completedCount = sections.where((s) => s['isCompleted'] == true).length;
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Tooltip(
                        message: "AI will expand and improve your input automatically.",
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Icon(
                            section['isCompleted'] ? Icons.check_circle : Icons.remove_circle,
                            color: section['isCompleted'] ? Colors.green : Colors.grey,
                          ),
                          ...
                          IconButton(
                            ...
                            onPressed: () async {
                              ...
                              final content = _cvModel.cvData[key];
                              dynamic previousData;

                              if (content is List) {
                                previousData = List<String>.from(content);
                              } else {
                                previousData = content?.toString() ?? '';
                              }
                    ...
                    if (isExpanded)
                      Container(
                        ...
                        child: _buildSectionContent(section['content'], section['key']),
                      ),
                  ],
                ),
              ),
